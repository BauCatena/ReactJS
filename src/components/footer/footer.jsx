    ...
    return(
        ...
        <footer className="footer">
            <div className="top-footer">
                <p className="text">Suscribite para recibir ofertas que no publicamos en ningún lado.</p>
                <div>
                    <input type="email" name="email" className="input" placeholder="Correo electrónico" />
